...
class MLPipelineRealColumns:
    """Pipeline ML complet avec vraies colonnes de production"""
    ...
    def preprocess(self):
        ...
        self.preprocessor = RealColumnRobustPreprocessor(target_col='Fondee')
...
if __name__ == "__main__":
    ...
    pipeline = MLPipelineRealColumns(config)
    pipeline.run()
