# 📖 Guide d'Utilisation avec Vos Données Réelles

## 🎯 Comment utiliser le pipeline avec vos propres données

Le pipeline est maintenant **100% adapté aux vraies colonnes** de votre base de données de production. Voici comment l'utiliser avec vos fichiers Excel réels.
...
Ouvrez `main_pipeline_real_columns.py` et ajustez la configuration si nécessaire:
...
python main_pipeline_real_columns.py
```
...
├── family_analysis_2025_real_cols.txt       # 📄 Analyse par famille produit
├── family_metrics_2025_real_cols.csv        # 📊 Métriques par famille (CSV)
├── metrics_2024_real_cols.json              # Métriques 2024
├── metrics_2025_real_cols.json              # Métriques 2025
├── feature_importance_real_cols.csv         # Importance des features
└── optuna_history_real_cols.csv             # Historique optimisation
```
...
├── family_analysis_2025_real_cols.png       # ⭐ ANALYSE PAR FAMILLE (NOUVEAU!)
├── confusion_matrix_2024_real_cols.png      # Confusion 2024
├── confusion_matrix_2025_real_cols.png      # Confusion 2025
├── roc_curve_2024_real_cols.png             # ROC 2024
├── roc_curve_2025_real_cols.png             # ROC 2025
├── pr_curve_2024_real_cols.png              # Precision-Recall 2024
├── pr_curve_2025_real_cols.png              # Precision-Recall 2025
├── calibration_curve_real_cols.png          # Calibration
└── prob_distribution_comparison_real_cols.png # Comparaison prédictions
```
...
```
outputs/models/
├── model_xgboost_real_cols_YYYYMMDD_HHMMSS.pkl  # Modèle entraîné
├── best_hyperparameters_real_cols.json           # Hyperparamètres optimaux
└── metadata_real_cols_YYYYMMDD_HHMMSS.json       # Métadonnées complètes

outputs/preprocessors/
├── preprocessor_real_cols.pkl                    # Preprocessing pipeline
└── feature_selector_real_cols.pkl                # Sélecteur de features
```
...
graph LR
    ...
    B --> C[Lancer main_pipeline_real_columns.py]
