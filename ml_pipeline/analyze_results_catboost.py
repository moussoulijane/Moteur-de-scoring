...
def generate_family_accuracy_chart(df_results):
    ...
    fig.suptitle('ACCURACY PAR FAMILLE DE PRODUIT - CatBoost', fontsize=16, fontweight='bold')
    ...
    bars1 = ax2.bar(x_pos, df_top['N_Total'], color='#9b59b6', alpha=0.6, label='Volume total', edgecolor='black', linewidth=1)
    ...
    ax2.set_ylabel('Volume', fontweight='bold', fontsize=11, color='#9b59b6')
